...
var maxSizeAllowed = 12;     // Upload limit in MB
var maxSizeInBytes = maxSizeAllowed * 4096 * 4096;
...
function saveAvatar(UserID) {
    ...
    $.ajax({
        ...
        if (data.success === true) {
            ...
            $(".popup-button").closest("#CreateAvatarPopup").dialog('close');
            GetAvatarContent();
            GetAvatarContentBig();
        } else {
